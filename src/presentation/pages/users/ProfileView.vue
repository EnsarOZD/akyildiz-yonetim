    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="md:col-span-1">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
          <div class="w-24 h-24 bg-brand-100 rounded-full flex items-center justify-center mx-auto mb-4 text-brand-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
          </div>
          <h2 class="text-lg font-bold text-gray-900">{{ authStore.fullName || 'Kullanıcı' }}</h2>
      ...
      <div class="md:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div class="px-6 py-4 border-b">
            <h3 class="font-bold text-gray-900">Bildirim Ayarları</h3>
          </div>
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div>
                <h4 class="text-sm font-semibold text-gray-900">Anlık Bildirimler</h4>
              ...
              <div class="flex items-center">
                <button 
                  ...
                  :class="isSubscribed ? 'bg-brand-500' : 'bg-gray-200'"
                >
                  <span 
            ...
            <div v-if="permissionStatus === 'denied'" class="mt-4 p-3 bg-red-50 border border-red-100 rounded-lg flex gap-3">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div class="px-6 py-4 border-b">
            <h3 class="font-bold text-gray-900">Güvenlik</h3>
          </div>
          <div class="p-6">
            <button class="w-full md:w-auto px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-200 transition">
              Şifre Değiştir
            </button>
          </div>
        </div>
