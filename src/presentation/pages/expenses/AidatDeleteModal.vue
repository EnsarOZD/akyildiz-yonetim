<template>
    <dialog open class="modal">
      <div class="modal-box max-w-sm bg-white dark:bg-[#0f1322] border border-gray-200 dark:border-white/[0.07]">
        <div class="flex items-center justify-between mb-4 pb-3 border-b border-gray-200 dark:border-white/[0.07]">
          <div class="flex items-center gap-2">
            ...
            <h3 class="text-lg font-semibold text-gray-800 dark:text-[#f1f3f9]">Aidat Kaydı Sil</h3>
          </div>
          <button @click="$emit('close')" class="btn btn-ghost btn-xs">✕</button>
        </div>
  
        <p class="text-sm text-gray-600 dark:text-[#f1f3f9]">
        ...
        <p class="text-sm mt-2 text-gray-500 dark:text-[#9aa0b4]">
