<template>
  <div class="space-y-8">
    <!-- Başlık -->
    <PageHeader title="Mal Sahibi Aidat Yönetimi" subtitle="Boşta olan katlar için yıllık aidat tutarlarını tanımlayın ve yönetin.">
      <template #icon>
...
import { UNIT_OPTIONS } from '@/core/constants/units'
