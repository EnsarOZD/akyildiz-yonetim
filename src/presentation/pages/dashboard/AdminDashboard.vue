<template>
  <div class="p-4 sm:p-6 min-h-screen pb-24 md:pb-6">
    ...
    <!-- Sayfa Başlığı -->
    <PageHeader title="Yönetim Paneli" subtitle="Mal sahipleri ve sistem kullanıcılarını buradan yönetin">
      <template #icon>
      ...
      <template #actions>
        <button @click="showAnnouncementModal = true" class="btn btn-sm btn-primary shrink-0">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988-1.564-.317z"/>
          </svg>
          Duyuru Yayınla
        </button>
      </template>
