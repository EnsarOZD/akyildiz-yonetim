<template>
  <router-link 
    to="/overdue" 
    class="bg-white dark:bg-[#0f1322] p-5 rounded-2xl shadow-sm border border-gray-200 dark:border-white/[0.07] hover:shadow-md hover:border-red-200 dark:hover:border-red-800 transition-all cursor-pointer group relative overflow-hidden"
  >
    ...
    <div class="flex flex-col h-full justify-between relative z-10">
      ...
      <div>
        <p class="text-sm font-medium text-gray-500 dark:text-[#9aa0b4]">Geciken Toplam</p>
        <h3 class="text-2xl font-black text-red-600 dark:text-red-400 mt-1">{{ formatCurrency(totalAmount) }}</h3>
        
        <div v-if="oldestDate" class="mt-3 flex items-center gap-1.5 text-[11px] font-medium text-gray-500 dark:text-[#9aa0b4]">
      ...
      <div class="mt-4 pt-4 border-t border-gray-100 dark:border-white/[0.07] flex items-center justify-between">
