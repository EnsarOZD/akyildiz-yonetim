      ...
      <form @submit.prevent="handleSave" id="tenantForm" class="space-y-10">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-3 px-1">
            ...
            <h4 class="text-[11px] font-black uppercase tracking-widest text-[#16283a]">İş Yeri Bilgileri</h4>
          </div>
          ...
          <div class="bg-[#f6fafd] border border-[#d9e7f2] rounded-2xl p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="form-control md:col-span-2">
                ...
                />
                <p v-if="formErrors.companyName" class="text-red-600 text-[10px] font-bold uppercase tracking-tight mt-2 italic">{{ formErrors.companyName }}</p>
              </div>
              ...
              <div class="form-control">
                ...
                <p v-if="formErrors.businessType" class="text-red-600 text-[10px] font-bold uppercase tracking-tight mt-2 italic">{{ formErrors.businessType }}</p>
              </div>
              ...
              <div class="form-control">
                ...
                <input
                  ...
                  inputmode="numeric"
                />
                <p v-if="formErrors.identityNumber" class="text-red-600 text-[10px] font-bold uppercase tracking-tight mt-2 italic">{{ formErrors.identityNumber }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-3 px-1">
            ...
            <h4 class="text-[11px] font-black uppercase tracking-widest text-[#16283a]">Yetkili İletişim Bilgileri</h4>
          </div>
          ...
          <div class="bg-[#f6fafd] border border-[#d9e7f2] rounded-2xl p-6">
            <div class="grid grid-cols-1 gap-6">
              ...
              <div class="form-control">
                ...
                >
                  <option v-for="flat in availableFlatsForTenant" :key="flat.id" :value="flat.id" class="py-2.5 px-4 hover:bg-brand-500/10 border-b border-[#ecf3f9] transition-colors">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-3 px-1">
            <div class="w-8 h-8 rounded-lg bg-brand-500/10 flex items-center justify-center text-brand-600 font-bold text-xs">💰</div>
            <h4 class="text-[11px] font-black uppercase tracking-widest text-[#16283a]">Finansal Bilgiler</h4>
          </div>
          ...
          <div class="bg-[#f6fafd] border border-[#d9e7f2] rounded-2xl p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-control justify-center">
              <label class="label cursor-pointer flex justify-start gap-4 p-0">
                ...
                <span class="label-text font-black uppercase tracking-widest text-[11px] text-[#5a7186]">Aktif Üyelik</span>
              </label>
            </div>
          </div>
        </div>
