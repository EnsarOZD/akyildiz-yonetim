...
const Tenants = () => import('../pages/tenants/Tenants.vue')
const Payments = () => import('../pages/payments/Payments.vue')
const Expenses = () => import('../pages/expenses/Expenses.vue')
const Utilities = () => import('../pages/expenses/Utilities.vue')
const TenantDetailPage = () => import('../pages/tenants/components/TenantDetailPage.vue')
const AdminDashboard = () => import('../pages/dashboard/AdminDashboard.vue')
const LoginView = () => import('../pages/auth/LoginView.vue')
const LandingPage = () => import('../pages/auth/LandingPage.vue')
const Transactions = () => import('../pages/common/Transactions.vue')
const OwnerDuesPanel = () => import('../pages/expenses/OwnerDuesPanel.vue')
const Owners = () => import('../pages/owners/Owners.vue')
const OwnerDues = () => import('../pages/common/OwnerDues.vue')
const OwnerPayments = () => import('../pages/common/OwnerPayments.vue')
const OverdueOwnerPayments = () => import('../pages/common/OverdueOwnerPayments.vue')
const Overdue = () => import('../pages/common/Overdue.vue')
const Flats = () => import('../pages/flats/Flats.vue')
const Reports = () => import('../pages/reports/ReportsView.vue')
...
const routes = [
  ...
  { path: '/tenant-dashboard', name: 'TenantDashboard', component: () => import('../pages/dashboard/TenantDashboard.vue'), meta: { requiresAuth: true, roles: ['tenant', 'admin', 'manager'] } },
  ...
  { path: '/payments', name: 'Payments', component: Payments, meta: { requiresAuth: true, roles: ['admin', 'manager', 'dataentry'] } },
  ...
  { path: '/my-payments', name: 'MyPayments', component: () => import('../pages/tenants/MyPaymentsView.vue'), meta: { requiresAuth: true, roles: ['admin', 'manager', 'tenant'] } },
  ...
  { path: '/invite', name: 'Invite', component: () => import('../pages/auth/SetPasswordView.vue'), meta: { public: true, hideLayout: true } },
  { path: '/:pathMatch(.*)*', name: 'NotFound', component: () => import('../pages/auth/NotFound.vue') },
  {
    path: '/transactions',
    name: 'Transactions',
