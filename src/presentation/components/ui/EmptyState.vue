<template>
  <div class="flex flex-col items-center justify-center py-16 px-4 text-center animate-fade-in">
    ...
    <div class="w-16 h-16 rounded-2xl bg-slate-100 flex items-center justify-center mb-4">
      <slot name="icon">
        <svg class="w-8 h-8 text-[#8298ab]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <p v-if="description" class="mt-1 text-sm text-slate-500 max-w-xs">{{ description }}</p>
